...
public class Documentation_Demo { 
  ...
  */   
  ...
  Scanner console = new Scanner(System.in);   // Scanner-keyboard input. 
    ...
    int totalPassed = 0;                        // no need for these comments.  
  ...
  * @param theTotalPassed contains how many scores were at least 75.    
  */   
  ...
  String output = "The class average = " + theClassAverage + "%\n" +                     
    ...
    // Display the results to the console.     System.out.println(output);   
  } 
  
  file:///C:/Users/Nazim/.grasp_settings/doc_tmp/Documentation_Demo.html
} 
